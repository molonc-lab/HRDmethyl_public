...
heatmap2 <- Heatmap(cell_line_col_df,
                    col = palette_100,
                    cluster_rows = FALSE,  # Since we pre-ordered the data
                    cluster_columns = h_cluster,
                    show_row_names = FALSE, # To show cell line names
                    show_column_names = TRUE,  # Turn off chr.start label
                    name = "Meth lvl",
                    top_annotation = ha, 
...
# The same heatmap code is repeated; only required if you need it plotted in another format
draw(heatmap2,heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
