...
#running=$(wc -l data/supporting/idat_mapping.tsv | cut -d ' ' -f 1)
#finished=$(ls | grep -E "mRNA_*.o*" | wc -l)
#while [ $finished != $(($running * 2)) ]; do running=$(wc -l data/supporting/idat_mapping.tsv | cut -d ' ' -f 1); #finished=$(ls | grep -E "mRNA_*.o*" | wc -l); sleep 20; done
