...
while [ $finished != $(($running * 2)) ]; do sleep 20; done
...
while [ $finished != $(($running * 2)) ];running=$(wc -l data/supporting/idat_mapping.tsv | cut -d ' ' -f 1); finished=$(ls | grep -E "beta_plot_*.o*" | wc -l); do sleep 20; done
rm -rf beta_plot_*.*
```
