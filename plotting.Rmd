...
ggsave(plot = PALB2_meth,filename = "plots/Supplementary/Sup4_PALB2me.pdf", height = 297/3*1.1, width = 200*1.1, units = "mm")
ggsave(plot = BRCA2_meth,filename = "plots/Supplementary/Sup4_BRCA2me.pdf", height = 297/3*1.1, width = 200*1.1, units = "mm")
ggsave(plot = BRIP1_meth,filename = "plots/Supplementary/Sup4_BRIP1me.pdf", height = 297/3*1.1, width = 200*1.1, units = "mm")
...
##Supplementary Table ??? - stage armitage_cochran ??
```{r}
#sex
ancestry_table <-  demograph_table_meth  %>%
  separate_rows(Methylation, sep = " & ") %>%
...
write.csv(rad51c_depmap_mat[c(hr_gene_list, "TP53", "PIK3CA", "ARID1A"),] , "data/source_data/figure_7b.csv", quote = F, row.names = F)
