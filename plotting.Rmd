...
stage <- demograph_table_meth %>%
  ...
  mutate(percent = n/total,
         stage = factor(stage, levels = c( 'I', 'IA', 'IB', 'IS', 'II', 'IIA','IIB','IIC', 'III','IIIA','IIIB','IIIC',  'IV', 'IVA', 'IVB', 'IVC','X','NA'))) %>%
...
tnbc <- demograph_table_meth %>%
  ...
  dplyr::select(Dataset, Sample.ID, Subtype, consensus_ancestry, Methylation)
