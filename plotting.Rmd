...
```
##Supplementary plot 5 HRD breakdown
```{r}
...
ggsave("plots/Supplementary/Sup5_HRD_breakdown.pdf", height = 10, width = 16)
```


##Supplementary plot 6 HRD score and expression
```{r}
...
ggsave("plots/Supplementary/Sup6_hrd_regression.pdf", height =4, width = 8)
...
write.csv(hrd_component_df %>%
            dplyr::select(Project, Methylation, Sample.ID, `HRD component`, value), "data/source_data/supplementary_figure_5.csv", quote = F, row.names = F)



write.csv(explore_df %>%
            dplyr::select(Project, Methylation, Sample.ID, purity, HRD_Score, avg_meth), "data/source_data/supplementary_figure_6a.csv", quote = F, row.names = F)

write.csv(explore_df %>%
            dplyr::select(Project, Methylation, Sample.ID, purity, HRD_Score, avg_meth, zscore), "data/source_data/supplementary_figure_6b.csv", quote = F, row.names = F)
